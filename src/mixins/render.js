  ...
  methods: {
    ...
    buildCaller(h) {
      ...
      input.push(h('div', {
        ...
        h('svg', {
          class: {'open-indicator': true},
          attrs: {xmlns: 'http://www.w3.org/2000/svg', width: 14, height: 10, role: 'presentation'}
        }, openIndicator)
      ]));
      ...
      return h('div', {class: 'sp-search'}, [
        h('input', {
          ...
          class: {
            ...
            'sp-search-input-no-valid': this.validationSearchError,
        ...
        h('span', {
          class: {
            'form-control-clear form-control-feedback hidden': true,
            'd-none': this.search.length === 0,
          },
          attrs: {
        ...
        h('span', {
          class: {
            'error-feedback': true,
            'd-none': null === this.validationSearchError,
          },
        }, [
          this.validationSearchError
        ]),
      ]);
    },
    buildMessage(h) {
