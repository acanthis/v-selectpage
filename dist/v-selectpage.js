...
import { ref as y, computed as R, watch as X, onMounted as ve, provide as E, nextTick as q, inject as z, defineComponent as Z, reactive as ge, onBeforeUnmount as He, onUnmounted as Ve, withDirectives as je, h as i, vShow as Ue, Teleport as Ge, Transition as me, openBlock as M, createElementBlock as k, createElementVNode as D, mergeProps as ae, toRef as we } from "vue";
const [
  oe,
  ie,
  re,
  ...
  13,
  27
], Ze = [oe, ie, re, se, ye, be], V = -1, Se = 0, We = 0, H = 1, Ke = 10, Ce = "first", te = "previous", ne = "next", _e = "last", x = "page_num", I = "page_count", $ = "row_count", A = "max_select_limit", T = "selected_count", [
  Xe,
  Y,
  Ye,
  qe,
...
function vt(e, t) {
  ...
  } = ht(e, t), r = y(""), g = y(""), h = y(H), p = y(0), _ = y([]), b = y(!1), L = ce(), B = () => le(_.value), S = (m) => {
  ...
  }), E("keyProp", e.keyProp), E("rtl", e.rtl), E("pageSize", e.pageSize), E("debounce", e.debounce), E("multiple", e.multiple), E("loading", b), E("language", n), E("renderCell", S), E("isItemSelected", o), E("selectedCount", a), E("removeAll", u), E("removeItem", d), E("fetchData", C), {
    selected: s,
    query: r,
    message: g,
    currentPage: h,
...
const De = "click", bt = "hover", St = "contextmenu", pe = 150, ee = 5;
function Ct(e, t) {
...
const At = Z({
  ...
  setup(e, { slots: t, emit: n, expose: s }) {
    ...
    function L() {
      const S = he(l.value), v = he(f.value), C = _t(e, u.y, S, v), O = Pt(e, u.x, S, v);
    ...
    return ve(() => {
      typeof e.width < "u" && (o.width = e.width + "px"), document.body.addEventListener("mousedown", B);
    }), He(() => {
      ...
      return g ? (O.onMouseenter = p, O.onMouseleave = _) : r ? O.onClick = (m) => {
...
const Rt = /* @__PURE__ */ N(Mt, [["render", Nt]]), Ft = {
  ...
  setup(e, { emit: t, expose: n }) {
    const { rtl: s, debounce: a, loading: o, language: u, selectedCount: d, multiple: c } = F(), l = y(!1), f = y(), r = ce(a), g = R(() => !c || !d.value ? u.search : u.selectedCount.replace(T, d.value)), h = () => ft(f.value);
    return n({ focus: h }), () => {
      const _ = [
...
const vn = /* @__PURE__ */ N(fn, [["render", pn]]), mn = {
  ...
  setup(e, { emit: t }) {
    ...
    return () => {
      const a = [
        { action: Ce, title: n.first, disabled: e.isFirstPage, icon: ln },
        { action: te, title: n.prev, disabled: e.isFirstPage, icon: sn },
        { action: ne, title: n.next, disabled: e.isLastPage, icon: gn },
        { action: _e, title: n.last, disabled: e.isLastPage, icon: vn }
      ].map((o) => {
        const u = {
...
function Le(e, t) {
  const {
    ...
    switchPage: m,
    pagingNavigation: P
  } = mt(e, u, d, n), W = ce(e.debounce), G = y();
  X(l, (w) => {
...
const In = /* @__PURE__ */ N(_n, [["render", xn]]), Ee = {
  ...
  setup(e, { emit: t, attrs: n, expose: s }) {
    ...
    return s({
      ...
      }, r = (B = c.value) != null && B.length ? () => i(j(n) ? Be : ze, f) : void 0, g = {
